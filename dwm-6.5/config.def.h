...
static const char *lightup[]        = { "/usr/bin/brightnessctl",         "set",             "+5%",                NULL };
static const char *lightdown[]      = { "/usr/bin/brightnessctl",         "set",             "5%-",                NULL };
static const char *mic[]            = { "/home/muhamad/.scripts/mic",     "toggle",                                NULL };
static const char *keymap[]         = { "/home/muhamad/.scripts/keymap",                                           NULL };
...
static const char col_cyan[]        = "#268bdf";
...
static const Key keys[] = {
  ...
  { ControlMask,                  XK_BackSpace,             spawn,          {.v = keymap } },
	TAGKEYS(                        XK_1,                                     0)
	TAGKEYS(                        XK_2,                                     1)
	TAGKEYS(                        XK_3,                                     2)
	TAGKEYS(                        XK_4,                                     3)
